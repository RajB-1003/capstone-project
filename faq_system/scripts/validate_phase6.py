...
from app.core.keyword_search  import build_bm25_index, search_keyword
from app.core.hybrid_search   import search_hybrid
from app.services.router    import load_regex_patterns, tier1_route
from app.services.router_tier2    import load_intent_exemplars, embed_intents, tier2_route

FAQS_PATH      = os.path.join("data", "configs", "faqs.json")
