...
from app.core.keyword_search  import search_keyword
from app.core.hybrid_search   import search_hybrid
from app.services.router    import tier1_route
from app.services.router_tier2    import tier2_route
...
from app.utils.profiler        import LatencyProfiler
from app.core.confidence      import get_query_type, check_confidence
from app.storage.feedback_store  import apply_feedback_reranking
from app.core.query_filter    import is_valid_unanswered_query   # Phase 2
from app.storage.db              import store_unanswered_query       # Phase 2
from app.storage.db              import log_query                    # Phase 5: analytics
...
def _track_unanswered(query: str, low_confidence: bool) -> None:
    ...
    try:
        if is_valid_unanswered_query(query):
            ...
            from app.storage.db import get_connection as _gc
            conn = _gc()
            try:
                row = conn.execute(
